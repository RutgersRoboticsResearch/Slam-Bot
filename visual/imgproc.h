 ...
 *  @param F the image to convolve
 *  @param H the convolution kernel
 *  @return the convolved image cube, where each layer is convolved
 */
 ...
 *  @return the interpolated image
 */
arma::cube imresize2rgb(const arma::cube &C, arma::uword m, arma::uword n);
 ...
 *  @return a pyramid
 */
std::vector<arma::mat> laplace_pyramid2(const arma::mat &H, size_t levels = 0);

/** Restore the image from a pyramid
 *  @param P the pyramid
